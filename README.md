This application is a simple radiometric dating calculator which will prompt a user from a menu to select a given radioactive element and its decay product. 
